...
class ProductListingTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function itShouldReturnProductListingPageHtml()
    {
        ...
        $keyValueStore->set('_men-accessories_v:1_0', '{"source_id":"","root_snippet_code":"product_listing","page_snippet_codes":["product_in_listing_118235-251_language:de_DE_website:ru"]}');
        $keyValueStore->set('product_listing__v:1.0', '<div>{{snippet product_1}}</div>');
        $keyValueStore->set('product_in_listing_118235-251_language:de_DE_website:ru__v:1.0', 'bar');
        ...
        $this->assertEquals('<div>bar</div>', $body);
    }
}
