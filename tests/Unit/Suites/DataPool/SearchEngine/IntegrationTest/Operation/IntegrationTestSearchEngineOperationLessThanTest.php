 ...
 */
class IntegrationTestSearchEngineOperationLessThanTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testThrowsAnExceptionIfSearchEngineOperationDataArrayDoesNotContainFieldName()
    {
        ...
        new IntegrationTestSearchEngineOperationLessThan(['fieldValue' => 'bar']);
    }
    ...
    public function testThrowsAnExceptionIfSearchEngineOperationFieldNameIsNonString()
    {
        ...
        new IntegrationTestSearchEngineOperationLessThan(['fieldName' => true, 'fieldValue' => 'bar']);
    }
    ...
    public function testThrowsAnExceptionIfSearchEngineOperationFieldNameIsEmpty(string $emptyString)
    {
        ...
        new IntegrationTestSearchEngineOperationLessThan(['fieldName' => $emptyString, 'fieldValue' => 'bar']);
    }
    ...
    public function testThrowsAnExceptionIfSearchEngineOperationDataArrayDoesNotContainFieldValue()
    {
        ...
        new IntegrationTestSearchEngineOperationLessThan(['fieldName' => 'foo']);
    }
