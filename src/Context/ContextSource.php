...
abstract class ContextSource
{
    ...
    public function getAllAvailableContexts()
    {
        if (null === $this->lazyLoadedAllAvailableContexts) {
            $this->lazyLoadedAllAvailableContexts = $this->contextBuilder->createContextsFromDataSets($this->getContextMatrix());
        }
    ...
    {
        return $this->contextBuilder->createContextsFromDataSets($this->getContextMatrixForParts($requestedContextParts));
    }
